    ...
    public static class MyFlatMap extends RichFlatMapFunction<Event, String> {
        ...
        public void open(Configuration parameters) throws Exception {
            ...
            StateTtlConfig ttlConfig = StateTtlConfig.newBuilder(Time.hours(1))
                    .setUpdateType(StateTtlConfig.UpdateType.OnReadAndWrite) // 默认是OnCreateAndWrite
                    .setStateVisibility(StateTtlConfig.StateVisibility.ReturnExpiredIfNotCleanedUp) // 设置状态可见性 默认NeverReturnExpired
                    .build(); // 一小时失效
